...
export default function (props, ref, key) {
  return (
    ...
    >
      ...
      >
        <skoash.Audio ref="sad" type="voiceOver" src="media/assets/_audio/VOs/VO_Sad.mp3" complete delay={1000} />
        <skoash.Audio ref="angry" type="voiceOver" src="media/assets/_audio/VOs/VO_Angry.mp3" complete delay={1000} />

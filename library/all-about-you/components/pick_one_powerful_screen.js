...
export default function (props, ref, key) {
    ...
    >
      ...
      >
        ...
        <skoash.Audio ref="not-powerful" type="voiceOver" src="media/assets/_audio/VOs/VO_DontFeel.mp3" complete delay={1000} />
        <skoash.Audio ref="unsure" type="voiceOver" src="media/assets/_audio/VOs/VO_Unsure.mp3" complete delay={1000} />
        <skoash.Audio ref="dont-care" type="voiceOver" src="media/assets/_audio/VOs/VO_DontCare.mp3" complete delay={1000} />
      </MediaCollection>

...
export default function (props, ref, key) {
    ...
    >
      ...
      >
        <skoash.Audio ref="worried" type="voiceOver" src="media/assets/_audio/VOs/VO_Worried.mp3" complete delay={1000} />
          <skoash.Audio ref="shocked" type="voiceOver" src="media/assets/_audio/VOs/VO_Shocked.mp3" complete delay={1000} />
          <skoash.Audio ref="no-big-deal" type="voiceOver" src="media/assets/_audio/VOs/VO_NoBig.mp3" complete delay={1000} />
      </MediaCollection>

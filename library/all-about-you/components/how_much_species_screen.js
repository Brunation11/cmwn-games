    ...
    >
      ...
      >
        <skoash.MediaSequence
          ...
          silentOnStart={true}
        >
          <skoash.Audio ref="a-lot-expression" type="voiceOver" src="media/assets/_audio/_Expressions/S_ALot.mp3" complete />
          <skoash.Audio ref="a-lot-vo" type="voiceOver" src="media/assets/_audio/VOs/VO_ALot.mp3" complete />
        </skoash.MediaSequence>
        <skoash.MediaSequence
          ref="a-little"
          checkComplete={true}
          silentOnStart={true}
        >
          <skoash.Audio ref="a-little-expression" type="voiceOver" src="media/assets/_audio/_Expressions/S_ALittle.mp3" complete />
          <skoash.Audio ref="a-little-vo" type="voiceOver" src="media/assets/_audio/VOs/VO_ALittle.mp3" complete />
        </skoash.MediaSequence>
        <skoash.MediaSequence
          ref="not-at-all"
          checkComplete={true}
          silentOnStart={true}
        >
          <skoash.Audio ref="not-at-all-expression" type="voiceOver" src="media/assets/_audio/_Expressions/S_NotAtAll.mp3" complete />
          <skoash.Audio ref="not-at-all-vo" type="voiceOver" src="media/assets/_audio/VOs/VO_NotAt.mp3" complete />
        </skoash.MediaSequence>
      </MediaCollection>

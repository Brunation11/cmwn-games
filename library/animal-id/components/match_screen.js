...
export default function (props, ref, key) {
    ...
    >
      <MatchableReveal
        ...
        matchableList={[
            <skoash.ListItem data-ref="frog" message="0" className="frog flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="frog2" message="0" className="lily-pad flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="cow" message="4" className="cow flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="cow2" message="4" className="grass flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="robin" message="1" className="robin flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="robin2" message="1" className="worm flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="fox" message="2" className="fox flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="fox2" message="2" className="mouse flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="dove" message="3" className="dove flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="dove2" message="3" className="cactus flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="hummingbird" message="5" className="humming-bird flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="hummingbird2" message="5" className="honeysuckle flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="rhino" message="6" className="rhino flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>
          </skoash.ListItem>,
            <skoash.ListItem data-ref="rhino2" message="6" className="oxpecker flip-container vertical animated">
            <skoash.Component className="flipper">
              <skoash.Component className="animated front" />
              <skoash.Component className="animated back" />
            </skoash.Component>

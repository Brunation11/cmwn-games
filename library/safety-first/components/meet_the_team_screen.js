...
export default function (props, ref, key) {
  ...
  return (
    <skoash.Screen
      ...
      id="meet-the-team"
    >
      <skoash.Audio ref="intro" type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/MeetTeam.mp3'} />
      ...
      >
        ...
        <skoash.MediaSequence
          ...
          silentOnStart
        >
          <skoash.Audio ref={`${answers[0]}-vo`} type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/Barkley.mp3'} />
          <skoash.Audio ref={`${answers[0]}-intro`} type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/BarkleyIntro.mp3'} startDelay={1000} />
        </skoash.MediaSequence>
        <skoash.MediaSequence
          ref={answers[1]}
          silentOnStart
        >
          <skoash.Audio ref={`${answers[1]}-vo`} type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/Shepherd.mp3'} />
          <skoash.Audio ref={`${answers[1]}-intro`} type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/ShepherdIntro.mp3'} startDelay={1000} />
        </skoash.MediaSequence>
        <skoash.MediaSequence
          ref={answers[2]}
          silentOnStart
        >
          <skoash.Audio ref={`${answers[2]}-vo`} type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/Wolf.mp3'} />
          <skoash.Audio ref={`${answers[2]}-intro`} type="voiceOver" src={ENVIRONMENT.MEDIA + 'SoundAssets/vos/WolfIntro.mp3'} startDelay={1000} />
        </skoash.MediaSequence>
      </MediaCollection>

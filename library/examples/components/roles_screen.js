...
var RolesScreen = (
  ...
  >
    <SelectableCanvas
      ...
      list={[
        <skoash.Component>
          <skoash.Image ref="img-1" src="media/S_3/img_3.1.png" />
        </skoash.Component>,
        <skoash.Component>
          <skoash.Image ref="img-2" src="media/S_3/img_3.3.png" />
        </skoash.Component>,
        <skoash.Component>
          <skoash.Image ref="img-3" src="media/S_3/img_3.5.png" />
        </skoash.Component>,
        <skoash.Component>
          <skoash.Image ref="img-4" src="media/S_3/img_3.7.png" />
        </skoash.Component>,
        <skoash.Component>
          <skoash.Image ref="img-5" src="media/S_3/img_3.9.png" />
        </skoash.Component>,
        <skoash.Component>
          <skoash.Image ref="img-6" src="media/S_3/img_3.11.png" />
        </skoash.Component>,
      ]}
    />
    <Reveal

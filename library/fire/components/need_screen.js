      ...
      <skoash.Component className="center">
        <skoash.Component className="frame">
          ...
          <DropzoneReveal
            ...
            revealAssets={[
              <skoash.Audio type="voiceOver" data-ref="pants" src="media/S_12/vo_TurnoutPants.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="jacket" src="media/S_12/vo_TurnoutJacket.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="hood" src="media/S_12/vo_CarbonFlashHood.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="boots" src="media/S_12/vo_ChemicalProofBoots.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="mask" src="media/S_12/vo_HelmetVisor.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="gloves" src="media/S_12/vo_SafetyGloves.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="tank" src="media/S_12/vo_TankOfOxygen.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="axe" src="media/S_12/vo_Axe.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="walkie" src="media/S_12/vo_HandHeldRadio.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="light" src="media/S_12/vo_Flashlight.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="camera" src="media/S_12/vo_ThermalImaging.mp3" />,
              <skoash.Audio type="voiceOver" data-ref="punch" src="media/S_12/vo_WindowPunch.mp3" />,
            ]}
          />
          </skoash.Component>
      </skoash.Component>

export default function (props, ref, key) {
    ...
    >
      <skoash.MediaSequence ref="media-sequence">
        <skoash.Audio ref="vo-1" type="voiceOver" src="media/_assets/_sounds/_vos/LitterIsTrash.mp3" />
        <skoash.Audio ref="vo-2" type="voiceOver" src="media/_assets/_sounds/_vos/PaperCansBottles.mp3" />
        <skoash.Audio ref="vo-3" type="voiceOver" src="media/_assets/_sounds/_vos/LetsCleanUp.mp3" />

...
let loop = function (opts, pat, canvas, ctx, listFire, listFirework, fireNumber, range) {
...
const update = function (opts, listFire, listFirework, fireNumber, range) {
...
const draw = function (opts, pat, canvas, ctx, listFire, listFirework) {
    // clear
...
export default function (node, opts) {
    ...
    loop = loop.bind(null, opts, pat, canvas, ctx, listFire, listFirework, fireNumber, range);

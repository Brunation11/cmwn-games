...
$(document).ready(function () {
    ...
    $('#key').click(function () {
        $('#key').hide();
        $('#key2').show(6000);
        $('#door').show().css("background-image", "url('content/images/open_doors.gif" + "?a=" + Math.random() + "')");
        $('#door-c').delay(8000).show().css("background-image", "url('content/images/closed_doors.gif" + "?a=" + Math.random() + "')");
        $('#frame1').fadeIn(2000).delay(4000).fadeOut();
        $('#first').fadeIn(2000).delay(4000).fadeOut();
    });

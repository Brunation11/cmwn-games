          ...
          */
          ...
          .pipe(inject(gulp.src(path.join('./library', game, 'config.game.js')), {
              ...
              transform: function (filePath, file) {
                ...
                `src="https://cdnjs.cloudflare.com/ajax/libs/react/15.0.2/react${min}.js"></script>\n  ` +
                '<script type="text/javascript" ' +
                `src="https://cdnjs.cloudflare.com/ajax/libs/react/15.0.2/react-dom${min}.js"></script>\n  ` +
                '<script type="text/javascript" ' +
